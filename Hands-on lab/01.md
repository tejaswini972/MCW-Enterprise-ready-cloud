...
3. Return to the **Policy** blade in the Azure portal. Select **Assignments**, then **Assign Policy**. Complete the form as follows:
    ...
    - Exclusions: **Select the Enterprise Ready Cloud management group, subscription, and ExpressRouteRG resource group which we had created earlier in Step 1**.
                  Then click on **Add to Selected Scope** and **Save**.
...
2. Specify the following details in the **Basics** balde and click on **Next:Configuration**.
    ...
    - Location: **Any available location in the allowed locations policy including East US, West US, North Europe, West Europe, Japan East, Japan West**.
     ...
     ![](images/Hands-onlabstep-by-step-Enterprise-readycloudimages/media/ExpressRoute1.png)

3. In the Configuration blade,specify the following details and click on **Review + Create**.
